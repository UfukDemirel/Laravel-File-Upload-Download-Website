                    ...
                    <div class="col-md-12">
                        <div class="form-block">
                            ...
                            <form action="{{route('loginpost')}}" method="post">
                                ...
                                <input type="submit" value="Log In" class="btn btn-pill text-white btn-block btn-dark">
                                <br>
                                <div class="d-flex mb-5 align-items-center">
                                    <label class="control control--checkbox mb-0"></label>
                                    <span class="ml-auto"><a href="{{route('register')}}" class="forgot-pass">Sign İn</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
